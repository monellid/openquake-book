...
\uppertitleback{
   ...
   Marco Pagani$^1$, Vitor Silva$^1$, Graeme Weatherill$^2$ \\ \hfill \\
   \small
   $^1$ GEM Foundation\\
   via Ferrata, 1 \\ 
   20133 Pavia \\
   Italy \\
   \\
   $^2$ GEM Model Facility\\
   via Ferrata, 1 \\ 
   20133 Pavia \\
   Italy \\
   \\
   $^3$ GEM Model Facility\\
   SED - ETHZ\\ 
   Sonneggstrasse, 5 \\
   CH-8092 Zurich\\
   Switzerland \\ 
...
\bibliography{./Bibliography/hazard.bib,./Bibliography/risk.bib,./Bibliography/sei.bib}
\end{document}
